import { TransferMoneyToUserController } from './../modules/statements/useCases/transferMoneyToUser/TransferMoneyToUserController';
...
statementRouter.post('/transfers/:user_to_id', transferMoneyToUserController.execute);
